...
Spc = (function() {
  ...
  return function(mem) {
    ...
    this.setp = function(adr, adrh, instr) { this.p = true; }
    this.clrc = function(adr, adrh, instr) { this.c = false; }
    this.setc = function(adr, adrh, instr) { this.c = true; }
    this.ei = function(adr, adrh, instr) { this.i = true; }
    this.di = function(adr, adrh, instr) { this.i = false; }
    this.clrv = function(adr, adrh, instr) { this.v = false; this.h = false; }

    this.bpl = function(adr, adrh, instr) { this.doBranch(!this.n, adr); }
    this.bmi = function(adr, adrh, instr) { this.doBranch(this.n, adr); }
    this.bvc = function(adr, adrh, instr) { this.doBranch(!this.v, adr); }
    this.bvs = function(adr, adrh, instr) { this.doBranch(this.v, adr); }
    this.bcc = function(adr, adrh, instr) { this.doBranch(!this.c, adr); }
    this.bcs = function(adr, adrh, instr) { this.doBranch(this.c, adr); }
    this.bne = function(adr, adrh, instr) { this.doBranch(!this.z, adr); }
    this.beq = function(adr, adrh, instr) { this.doBranch(this.z, adr); }
    ...
    this.pushp = function(adr, adrh, instr) { this.push(this.getP()); }
    this.pusha = function(adr, adrh, instr) { this.push(this.r[A]); }
    this.pushx = function(adr, adrh, instr) { this.push(this.r[X]); }
    this.pushy = function(adr, adrh, instr) { this.push(this.r[Y]); }
    this.popp = function(adr, adrh, instr)  { this.setP(this.pop()); }
    this.popa = function(adr, adrh, instr)  { this.r[A] = this.pop(); }
    this.popx = function(adr, adrh, instr)  { this.r[X] = this.pop(); }
    this.popy = function(adr, adrh, instr)  { this.r[Y] = this.pop(); }
    ...
    // JIT: Pre-bind all functions inside constructor exactly once to avoid slow .call runtime checks
    for (let i = 0; i < 256; i++) {
