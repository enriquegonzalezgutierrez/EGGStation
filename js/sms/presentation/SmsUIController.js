...
window.ConsoleRegistry.register("SMS", (videoCtx, glCtx, updateFps) => {
    const orchestrator = new SmsOrchestrator(videoCtx, glCtx, updateFps);
    const controller = new SmsUIController(orchestrator);
