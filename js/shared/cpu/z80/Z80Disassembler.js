 ...
 * File: js/shared/cpu/z80/Z80Disassembler.js
 * 
 * Role:
 ...
 * 1. Single Responsibility Principle (SRP): Exclusively handles the disassembly 
 *    and formatting of binary opcodes into human-readable mnemónicos text.
 *    It has no influence over actual instruction execution or memory states.
 * 2. Dependency Inversion Principle (DIP): The Developer Suite UI relies on 
 *    this isolated abstraction to parse the program memory stream safely rather 
 *    than tightly coupling to the state of the active CPU core loop.
 */
