 ...
 * File: js/shared/cpu/z80/instructions/Z80SystemIO.js
 * 
 * Role:
 ...
 * OTDR, NOP, HALT, DI, EI, IM). Decoded commands follow the Command Pattern (SRP).
 * 
...
class Z80SystemIO {
    /**
     * Registers all System and I/O opcodes onto the provided CPU opcode maps.
