 ...
 * File: js/shared/cpu/m68k/m68k.js
 * 
 * Role:
 * Domain Layer: Motorola 68000 (M68K) CPU Core.
...
class M68000 {
    /**
     * @param {Object} bus - The abstract M68K memory bus interface.
     */
    constructor(bus) {
        this.bus = bus;
    ...
    reset() {
        ...
        if (this.bus) {
            ...
            console.log(`%c[M68K::Reset] Bootstrap Vectors Loaded.`, "color: #ff007f; font-weight: bold;");
            console.log(`[M68K::Reset] SSP (Stack Pointer): 0x${this.ssp.toString(16).toUpperCase().padStart(8, '0')}`);
            console.log(`[M68K::Reset] PC (Program Counter): 0x${this.pc.toString(16).toUpperCase().padStart(8, '0')}`);
        }
    }
